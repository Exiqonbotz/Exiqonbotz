...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&pause=1000&center=true&vCenter=true&color=FF4D4D&width=450&lines=🔥+Dev+from+Germany;🔥+Phoenix+Bot+–+Next+Gen+WA+Bot;🔥+Selfhosting+for+everyone;🔥+Coding+with+passion" alt="Typing SVG" />
</p>
...
[![Phoenix-Baileys](https://img.shields.io/badge/🔥%20Phoenix%20Baileys-Actively%20in%20Development-ff4d4d?style=for-the-badge&logo=whatsapp&logoColor=white)](https://github.com/Exiqonbotz/phoenix-baileys-v2)

- 💻 Selfhosting for everyone: `Phoenix🐦‍🔥` is fully open and modular
- 🧠 100% code control – no dependency on third-party instances
- 🛠️ Multi-Device, PM2, Node.js
- 📦 Supports add-ons, games, economy, filters, and more
